...
def main():
    ...
    keep = (register.both(is_review, register.seen_within(args.new_since_days))
            if args.new_since_days else is_review)
    ...
    extract_runner.run(
        ...
        workers=args.workers, budget=args.budget, label="рішень ВРП",
